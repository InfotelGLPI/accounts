...
if (!is_readable(PLUGIN_ACCOUNTS_DIR . "/locales/".$_GET['lang'].".php")) {
   print "Unable to read dictionnary file\n";
   exit();
}
include (PLUGIN_ACCOUNTS_DIR . "locales/en_GB.php");
$REFLANG = $LANG;

$lf     = fopen(PLUGIN_ACCOUNTS_DIR . "/locales/".$_GET['lang'].".php", "r");
$lf_new = fopen(PLUGIN_ACCOUNTS_DIR . "/locales/temp.php", "w+");
...
include (PLUGIN_ACCOUNTS_DIR . "/locales/temp.php");

if (!is_readable(PLUGIN_ACCOUNTS_DIR . "/locales/glpi.pot")) {
   print "Unable to read glpi.pot file\n";
   exit();
}
$current_string_plural = '';

$pot = fopen(PLUGIN_ACCOUNTS_DIR . "/locales/glpi.pot", "r");
$po  = fopen(PLUGIN_ACCOUNTS_DIR . "/locales/".$_GET['lang'].".po", "w+");
