...
xgettext *.php */*.php --copyright-holder='Accounts Development Team' --package-name='GLPI - Accounts plugin' --package-version='1.9.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
