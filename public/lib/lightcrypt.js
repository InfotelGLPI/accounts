/*!
 * lightcrypt.js — third-party code vendored into this plugin. NOT covered by the
 * plugin's GPL licence. See public/lib/VERSIONS for provenance.
 *
 * This file is an assembly of two independent upstream sources:
 *
 *   1. AES / AES-CTR (Cipher, KeyExpansion, AESEncryptCtr, AESDecryptCtr)
 *      (c) Chris Veness 2005-2011 | MIT Licence
 *      https://www.movable-type.co.uk/scripts/aes.html
 *      The PHP counterpart of this code lives in src/AesCtr.php.
 *
 *   2. SHA-256 (SHA256)
 *      Original code by Angel Marin and Paul Johnston | BSD Licence
 *      http://www.webtoolkit.info/
 *
 * Kept for backward compatibility only: it decrypts v1 cryptograms and checks
 * legacy double SHA-256 verifiers. New records use crypto-js (see public/crypt.js).
