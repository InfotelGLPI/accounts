...
UPDATE `glpi_items_problems` SET `itemtype` = 'GlpiPlugin\\Accounts\\Account' WHERE `itemtype` = 'PluginAccountsAccount';
UPDATE `glpi_items_projects` SET `itemtype` = 'GlpiPlugin\\Accounts\\Account' WHERE `itemtype` = 'PluginAccountsAccount';
